#===================================================#
#### PRIMER INFORME ANALISIS MULTIVARIADO I 2016 ####
#===================================================#
...
# Para cada a?o se muestra la variable res?men (nombre) para cada uno de los 
# grupos construidos
...
##### Variables referentes a la sutuaci?n de empleo #####
...
# Seleccionamos trabajar con los 10 grupos definidos por el m?todo Complete 
# Linkage
...
# numero del grupo con mayor coef. de pertenencia)
...
#### Discriminante Multinomial (conformacion de grupos) ####
...
# los valores del estad?stico de Wald para cada regresor en cada ecuaci?n
w1 <- summary(rmlog, Wald=TRUE)

# Armo una matrix con el valor absoluto de los estad?sticos de Wald para cada
...
# Estimamos el modelo multi logostico
