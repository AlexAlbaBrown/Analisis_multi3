...
$$\begin{array}{rcl}
\log \pi_g - \frac{1}{2} D_{ig}^2 & = & \log \pi_g - \frac{1}{2} \left[ (\mathbf{x}_i - \mathbf{\mu}_g)' \mathbf{\Sigma}^{-1} ((\mathbf{x}_i - \mathbf{\mu}_g)) \right] \\ \\
   ...
   & = & \log \hat{\pi}_g - \frac{1}{2} \mathbf{x}'_i \, \mathbf{S}^{-1} \, \mathbf{x}_i + \frac{1}{2} \mathbf{\bar{x}}'_g \, \mathbf{S}^{-1} \, \mathbf{x}_i + \frac{1}{2} \mathbf{x}'_i \, \mathbf{S}^{-1} \, \mathbf{\bar{x}}_g - \frac{1}{2} \mathbf{\bar{x}}'_g \, \mathbf{S}^{-1} \, \mathbf{\bar{x}}_g
\end{array}$$
