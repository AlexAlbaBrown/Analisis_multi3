...
Los algoritmos fuzzy se basan en computar la probabilidad de que cada observación pertenezca a cada cluster. Se comienza con $k$ clusters y a cada observación se le asigna una probabilidad de pertenencia a cada cluster.
