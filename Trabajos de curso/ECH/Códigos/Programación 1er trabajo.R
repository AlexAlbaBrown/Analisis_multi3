#######################################################
##### PRIMER INFORME ANÁLISIS MULTIVARIADO I 2016 #####
#######################################################

rm(list=ls())
setwd("F:/UdelaR/CCEEA/Semestre 7/Análisis Multivariado I/Informes")
...
source("C:/Users/dacza/Dropbox/Funciones R/panelcor.R")
source("C:/Users/dacza/Dropbox/Funciones R/panelhist.R")
source("C:/Users/dacza/Dropbox/Funciones R/indicadores.R")
...
# Para cada año se muestra la variable resúmen (nombre) para cada uno de los 
# grupos construidos
...
sexcolor <- rep(c(rep("lightskyblue", 9), rep("palegreen3", 9)), 2)
...
write.csv(cor, file="tablas y salidas/cor.csv")
...
##### Variables referentes a la sutuación de empleo #####
...
# Seleccionamos trabajar con los 10 grupos definidos por el método Complete 
# Linkage
...
write.csv(ech, "tablas y salidas/ech con grupos.csv")
...
# los valores del estadístico de Wald para cada regresor en cada ecuación
w1 <- summary(rmlog, Wald=TRUE)

# Armo una matrix con el valor absoluto de los estadísticos de Wald para cada
